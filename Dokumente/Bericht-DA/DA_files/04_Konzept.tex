...
Das konzeptuelle Design beschreibt die Funktionalitäten des Assistenzsystems. Dazu wird zunächst dargestellt, welche Faktoren berücksichtigt werden.\todo{besser formulieren}
\begin{figure}[htbp]
\centering
