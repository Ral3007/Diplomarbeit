...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.28]{DA_files/Bilder/Anhang/Procedures.pdf}
...
\begin{figure}[hb]
\centering
\includegraphics[scale=0.58]{DA_files/UML/Anhang/Aktivitaetsdiagramm-Problem.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.66]{DA_files/Bilder/Anhang/Fragebogen-Vorwissen.pdf}
\caption{Fragebogen: Aussagen zum Vorwissen}
\end{figure}
\begin{figure}[h!]
\centering
\includegraphics[scale=0.66]{DA_files/Bilder/Anhang/Fragebogen-Auswertung-1.pdf}
\caption{Fragebogen: SUS Fragebogen}
\end{figure}

\begin{figure}[t!]
\centering
\includegraphics[scale=0.66]{DA_files/Bilder/Anhang/Fragebogen-Auswertung-2.pdf}
