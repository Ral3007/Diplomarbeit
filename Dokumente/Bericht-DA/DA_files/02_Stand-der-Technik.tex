...
Während Menschen direkt kommunizieren können ist bei der Kommunikation mit einer digitalen Assistenz noch Hardware notwendig. Welche dafür verwendet werden kann ist in Abschnitt xx näher beschrieben. Bei Betrachtung des Apsekts WIE kommuniziert wird, dann fällt auf, dass es vielfältige Möglichkeiten gibt. 
...
Die Eingabemethoden orientieren sich maßgeblich an den Fähigkeiten des Menschen. Der Mensch verwendet meist Hände und Sprache. Insbesondere die Hände bieten eine Vielzahl an Möglichkeiten mit einem System zu interagieren. So können Hilfsmittel, wie Maus oder Tasten, verwendet werden oder interagiert direkt mit Gesten oder über ein Touchscreen. Neben der Fragen mit WAS der Mensch interagiert ist vor allem interessant WIE interagiert wird. Die Möglichkeiten sind in Tabelle x aufgeführt.
...
\begin{tabular}{p{3cm}|p{4cm}|p{4cm}|p{3cm}|p{3cm}}
	...
	\hline
	Maus & zweidimensionale Bewegung & & & \\
	\hline
	Joystick & & & & \\
	\hline
	...
	\hline
	Spracheingabe & & einfach zu bedienen & & \\
	\hline
	Gesten & & & & \\
	\hline
\end{tabular}
...
Mit Schnittstelle ist gemeint, wie und mit welchen Mitteln Informationen dem Nutzer zur Verfügung gestellt werden. Die Mittel sind in Tabelle x dargestellt.
...
\begin{tabular}{p{2,6cm}|p{3,5cm}|p{3,5cm}|p{3,5cm}|p{3,5cm}}
	...
	\hline
	Headset & gibt akustisch Hinweise und Informationen & handsfree & funktioniert nur bedingt in lauter Umgebung & Call-Center, Logistik \\
	\hline
