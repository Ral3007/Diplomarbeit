...
Soll jeder Nutzer des Assistenzsystemes individuell unterstützt werden so ist herauszufinden, ob der Mensch aktuell mit der Aufgabe über- oder unterfordert ist. Kann der Mensch einen Automatisierungsgrad wählen, so bewegt er sich auf einem mittleren Automatisierungsgrad. Das System macht dabei Vorschläge, die vom Menschen bestätigt oder ausgewählt werden müssen. Unerwünscht sind Systeme, die Aufgaben automatisch ausführen, wenn der Mensch diese nicht rechtzeitig abbricht. \cite{}
